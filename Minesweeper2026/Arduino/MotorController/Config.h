 ...
 *   3. Soft-I2C IMU harness (avoids D20/D21 encoder conflict without cutting copper)
 *
 * @file   Config.h
...
/**
 * Limit switches on the Magnets/Lift sub-board are stepped down from 12 V
...
namespace SensorConfig {
    ...
    constexpr uint16_t BUZZER_FREQ_HZ = 500;  /* Used only if BUZZER_IS_SIREN_RELAY == 0 */
}
